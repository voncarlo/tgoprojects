...
export const KpiCard = ({ label, value, icon: Icon, tone }: KpiCardProps) => {
  return (
    <div className="group relative rounded-2xl border border-border/70 bg-card p-5 shadow-card transition-all hover:shadow-card-hover hover:-translate-y-0.5">
